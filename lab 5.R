> getwd()
[1] "/"
> load("~/Downloads/BRFSS2022 (1)/BRFSS2022_rev.RData")
> library(ggplot2)
> library(tidyverse)
> require(class)
> require(caret)
...
> brfss22$Educ_number <- fct_recode(brfss22$EDUCA, 
                                    ...
                                    +                                   NULL = "Refused" )
> rfss22$Educ_number <- as.numeric(levels(brfss22$Educ_number))[brfss22$Educ_number]
Error: object 'rfss22' not found
